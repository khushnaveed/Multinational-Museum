...
const cardStyle = {
  ...
  backgroundColor: '#000000', // bg-gray-800
...
const bookContentStyle = {
  ...
  backgroundColor: '#212529', //text area of card bg color
  padding: '1rem',
};
  ...
  >
    <div style={bookContainerStyle}>
      ...
      <div style={bookContentStyle}>
        <h2 style={{ fontSize: '2.25rem', fontWeight: '800', marginBottom: '1rem' }}>{artwork.title}</h2>
        <p style={{ fontSize: '0.875rem', marginBottom: '0.25rem' }}>Artist: {artwork.artist}</p>
        <p style={{ fontSize: '0.875rem', marginBottom: '0.25rem' }}>Year: {artwork.year}</p>
        <p style={{ fontSize: '0.875rem', marginBottom: '0.5rem' }}>Category: {artwork.category}</p>
